...
//     SET_STDSCI_PACK_TX_OVERRUN_INTERVAL(&(btx_ptr->pck_0xB2), hall_ptr->num_pwm_60d_p, 999); //1s interval
     ...
     SET_STDSCI_PACK_TX_OVERRUN_INTERVAL(&(btx_ptr->pck_0xF0), feedback_Test0, 999);
     SET_STDSCI_PACK_TX_OVERRUN_INTERVAL(&(btx_ptr->pck_0xF1), feedback_Test1, 999);
     SET_STDSCI_PACK_TX_OVERRUN_INTERVAL(&(btx_ptr->pck_0xF2), feedback_Test2, 999);
     SET_STDSCI_PACK_TX_OVERRUN_INTERVAL(&(btx_ptr->pck_0xF3), feedback_Test3, 999);
