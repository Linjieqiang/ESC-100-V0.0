...
// ...........................................................
   ...
   */
   void STDSCI_BLOCK_TX_Init(void)
   {
     ...
     STDSCI_PACK_TX_Init(FeedBack_PWM_NUM_Predicted, &(btx_ptr->pck_0xB2), &(btx_ptr->pck_0xC0));

     STDSCI_PACK_TX_Init(FeedBack_CDE_SMC, &(btx_ptr->pck_0xC0), &(btx_ptr->pck_0xC1));
     STDSCI_PACK_TX_Init(FeedBack_CDE_SMM, &(btx_ptr->pck_0xC1), &(btx_ptr->pck_0xF0));

     STDSCI_PACK_TX_Init(FeedBack_Test0, &(btx_ptr->pck_0xF0), &(btx_ptr->pck_0xF1));
     STDSCI_PACK_TX_Init(FeedBack_Test1, &(btx_ptr->pck_0xF1), &(btx_ptr->pck_0xF2));
     STDSCI_PACK_TX_Init(FeedBack_Test2, &(btx_ptr->pck_0xF2), &(btx_ptr->pck_0xF3));
     STDSCI_PACK_TX_Init(FeedBack_Test3, &(btx_ptr->pck_0xF3), btx_ptr->thread_ptx_ptr);
   }
//
